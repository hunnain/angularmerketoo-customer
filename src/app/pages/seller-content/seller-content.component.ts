...
@Component({
  selector: 'app-seller-content',
  templateUrl: './seller-content.component.html',
  styleUrls: ['./seller-content.component.scss']
})
export class SellerContentComponent implements OnInit {
